...
import avnpost.com.main.VideoActivity;
import avnpost.com.model.AVNApplication;

public class CustomListAdapter extends BaseAdapter {
    Activity activity;
    ImageLoader imageLoader = AVNApplication.getInstance().getImageLoader();
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        if (this.imageLoader == null) {
            this.imageLoader = AVNApplication.getInstance().getImageLoader();
        }
